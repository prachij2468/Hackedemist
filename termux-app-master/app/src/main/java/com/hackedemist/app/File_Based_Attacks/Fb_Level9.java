...
import com.hackedemist.app.File_Based_Attacks.Fb_Hints.Fb_Hints9;
...
public class Fb_Level9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    Thread complete =new Thread(){
                        ...
                        public void run() {
                            try {
                                ...
                                startActivity(i);
                                sleep(3000);
                                i = new Intent(Fb_Level9.this,Level_next.class);
                                startActivity(i);
                            }
        ...
        next10Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Fb_Level9.this, Level_next.class));
            }
        });
        ...
        hint10btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateCoins();
                startActivity(new Intent(Fb_Level9.this, Fb_Hints9.class));
            }
        });
