...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint2;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        submit2Btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(Hd_Level3.this,"Level Completed ",Toast.LENGTH_LONG).show();
        ...
        home_hd3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Hd_Level3.this, Host_discovery.class));
            }
        });
