...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint5;
...
import com.hackedemist.app.UserEnumeration.Ue_Hints.Ue_Hints2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(users.equals("skiwn*mi!")){
                    Toast.makeText(Ue_Level2.this,"Level Completed",Toast.LENGTH_LONG).show();
        ...
        hint5btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateCoins();
                startActivity(new Intent(Ue_Level2.this, Ue_Hints2.class));
            }
        });
