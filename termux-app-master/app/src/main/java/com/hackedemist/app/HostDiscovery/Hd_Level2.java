...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level1btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ip.equals("192.185.129.21")){
                    ...
                    Toast.makeText(Hd_Level2.this,"Level Completed ",Toast.LENGTH_LONG).show();
        ...
        home_hd2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Hd_Level2.this, Host_discovery.class));
            }
        });
