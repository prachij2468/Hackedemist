...
// Hide the status bar.
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(Host_discovery.this);
         ...
         hd_LevelTrack = prefs.getInt("hd_levelTrack",0);
        ...
        home_hd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Host_discovery.this, Level_next.class));
            }
        });
    ...
    void updateFirebaseLocks()
    {
        switch (hd_LevelTrack)
        {
            case 1:
                lock2 = true;
                break;
            ...
            case 2:
                ...
                break;
            case 3:
                lock2 = lock3 = lock4 = true;
                break;
            case 4:
                lock2 = lock3 = lock4 = lock5 =  true;
                break;
            case 5:
                lock2 = lock3 = lock4 =lock5 = lock6 = true;
                break;

            case 6:
                lock2 = lock3 =lock4 = lock5 = lock6 =lock7 =true;
                break;
