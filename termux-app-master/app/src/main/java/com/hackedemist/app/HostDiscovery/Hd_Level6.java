...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_hd6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Hd_Level6.this, Host_discovery.class));
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ip.equals("25")&&subdomains.equals("9")){
                    Toast.makeText(Hd_Level6.this,"Level Completed ",Toast.LENGTH_LONG).show();
