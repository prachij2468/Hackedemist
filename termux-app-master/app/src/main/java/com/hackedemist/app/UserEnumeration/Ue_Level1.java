...
import com.hackedemist.app.UserEnumeration.Ue_Hints.Ue_Hints1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(users.equals("11")){
                    Toast.makeText(Ue_Level1.this,"Level Completed",Toast.LENGTH_LONG).show();
        ...
        hint5btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateCoins();
                startActivity(new Intent(Ue_Level1.this, Ue_Hints1.class));
            }
        });
