...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Level9btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Hd_Level7.this,"Level Completed ",Toast.LENGTH_LONG).show();
                    ...
                    if (!lock)
                    {
                        ...
                        updateCoins();
                        Level_start.updateFirebaseCoins(prefs);
                    }
        ...
        next9Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Hd_Level7.this, Level_next.class));
            }
        });
        ...
        prev9Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Hd_Level7.this, Hd_Level6.class));
            }
        });
