...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit3Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(port.equals("21")){
                    Toast.makeText(Hd_Level4.this,"Level Completed ",Toast.LENGTH_LONG).show();
        ...
        home_hd4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Hd_Level4.this, Host_discovery.class));
            }
        });
