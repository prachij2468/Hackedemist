...
import com.hackedemist.app.HostDiscovery.Hd_hints.ActivityHint4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_hd5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Hd_Level5.this, Host_discovery.class));
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cb1.isChecked() && !(cb2.isChecked()) && cb3.isChecked() && !(cb4.isChecked())) {
                        ...
                        Toast.makeText(Hd_Level5.this, "Level Completed ", Toast.LENGTH_LONG).show();
