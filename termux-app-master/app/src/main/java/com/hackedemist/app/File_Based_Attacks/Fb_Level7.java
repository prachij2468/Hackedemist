...
import com.hackedemist.app.File_Based_Attacks.Fb_Hints.Fb_Hints7;
...
public class Fb_Level7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Readme7 = (TextView) findViewById(R.id.fb_readme7);
        ...
        submit10btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans1.equals("UsvVyFSfZZWbi6wgC7dAFyFuR6jQQUhR"))
                {
                    if (!lock)
                    {
        ...
        hint10btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateCoins();
                startActivity(new Intent(Fb_Level7.this, Fb_Hints7.class));
            }
        });
